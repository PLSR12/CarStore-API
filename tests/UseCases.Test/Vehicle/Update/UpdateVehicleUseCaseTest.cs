...
namespace UseCases.Test.Vehicle.Update
{
    public class UpdateVehicleUseCaseTest
    {
        ...
        public async Task Success()
        {
            ...
            var result = await useCase.Execute(request, vehicle.Id);
        ...
        public async Task Error_Model_Empty()
        {
            ...
            Func<Task> act = async () => await useCase.Execute(request, vehicle.Id);
        ...
        private static UpdateVehicleUseCase CreateUseCase(CarStore.Domain.Entities.Vehicle vehicle, Brand brand, TypesVehicle typesVehicle)
        {
            ...
            return new UpdateVehicleUseCase(loggedUser, vehicleRepository, brandRepository, typeVehicleRepository, userReadOnlyRepository, unitOfWork, mapper);
        }
    }
}
