...
namespace Validators.Test.User.Register
{
    public class RegisterUserValidatorTest
    {
        ...
        [InlineData(4)]
        [InlineData(5)]
        public void Error_Pasword_Invalid(int passwordLength)
        {
            var validator = new RegisterUserValidator();
            ...
            result
                .Errors.Should()
                .ContainSingle()
                .And.Contain(e => e.ErrorMessage.Equals(ResourceMessagesException.PASSWORD_LENGTH));
        }

        [Fact]
        public void Error_Pasword_Empty()
        {
            var validator = new RegisterUserValidator();
